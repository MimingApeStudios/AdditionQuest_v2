...
function serveMonster() {
    ...
    $("#monster").html("<img src='../www/img/monsters/monster"+monsterNum+".png' height='180px' />");
    // Play audio
    var audio = new Audio('../www/audio/monster'+monsterNum+'.mp3');
    audio.volume = 1;
    audio.play();
...
function buttonPressed(total, value) {
    ...
    if (total == value) {
        var btnaudio = new Audio('../www/audio/jump.mp3');
        btnaudio.play(); 
       ...
       // alert( highScore );
        ...
        loseaudio.play(); 
        $("#mainContent").html("<p>YOU LOSE!</p><img src='../www/img/rip.png' height='180px' />");
        $("#monster").html("")
        round = round -1;
...
function levelUp() {
        var levelAudio = new Audio('../www/audio/horn.mp3');
        levelAudio.play(); 
        $("#mainContent").html("<p>LEVEL UP</p>");
        $("#monster").html("<img src='../www/img/star.gif' height='180px' />");
